...
const config: Config = {
  title: 'MotionGen',
  tagline: 'A Mechanism Design and Simulation Software',
  ...
  organizationName: 'snappyxo', // Usually your GitHub org/user name.
  projectName: 'motiongen-docs', // Usually your repo name.
