...
<DocAnimation
  src={'/video/geometry-constructions-for-mechanism-design/copy-a-triangle-using-sas.mp4'}
  title="copy a triangle using SAS"
  border={true}
/>
...
<DocAnimation
  src={'/video/geometry-constructions-for-mechanism-design/copy-a-triangle-using-sss.mp4'}
  title="copy a triangle using SSS"
  border={true}
/>
...
<DocAnimation
  src={'/video/geometry-constructions-for-mechanism-design/copy-a-triangle-using-asa.mp4'}
  title="copy a triangle using ASA"
  border={true}
/>
