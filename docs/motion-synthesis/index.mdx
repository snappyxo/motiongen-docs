...
<DocImage
  src={'/img/motion-synthesis/motion-synthesis-panel.png'}
...
<DocAnimation
  src={'/video/motion-synthesis/five-poses.mp4'}
  title="five poses"
  border={true}
/>
...
<DocAnimation
  src={'/video/motion-synthesis/four-poses-one-line-constraint.mp4'}
...
<DocAnimation
  src={'/video/motion-synthesis/three-poses-two-pivot-constraints.mp4'}
...
<DocAnimation
  src={'/video/motion-synthesis/two-poses-three-pivot-constraints.mp4'}
